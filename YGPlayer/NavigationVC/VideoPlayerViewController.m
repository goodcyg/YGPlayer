...
- (void)viewDidLoad {
    ...
    // Do any additional setup after loading the view.
     ...
     strUrl=@"http://127.0.0.1:10086/20184k.m4v";
     ...
     //设置播放器额外属性
     playerView.playedColor   = UIColorWithRGB(21,90,203);
     playerView.cacheBarColor = [UIColor grayColor];
     ...
     playerView.moreClickBlock = ^(){
         ...
         weakSelf.playerView.playerUrl =strUrl;// @"http://hd.yinyuetai.com/uploads/videos/common/B47E013A6407D27C66A5DF307657F2B3.flv?sc=741fb0d8a9b7028c&br=1099&rd=iOS";
