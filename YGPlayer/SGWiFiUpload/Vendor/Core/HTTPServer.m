...
// Other flags: trace
static const int httpLogLevel = HTTP_LOG_LEVEL_OFF; // HTTP_LOG_LEVEL_INFO | HTTP_LOG_FLAG_TRACE;
...
- (id)init
{
    if ((self = [super init])) {
        ...
        serverQueue = dispatch_queue_create("com.ftx.HTTPServer", NULL);
...
- (void)connectionDidDie:(NSNotification*)notification
{
    ...
    {
        for (HTTPConnection* newConnection in connections) {
            if (newConnection) {
                [newConnection stop];
            }
        }
